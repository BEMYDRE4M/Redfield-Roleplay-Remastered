...
addEventHandler("Drogenschiff.openWindow",root,function()
	if(isWindowOpen())then
        ...
        GUIEditor.label[2] = guiCreateLabel(10, 67, 325, 57, loc("Fraktionen_3"):format(math.floor(Drogenschiff.preis/100*150)), false, GUIEditor.window[1])
		...
		if(getDistanceBetweenPoints3D(2351.6687011719,545.11804199219,1.796875,getElementPosition(localPlayer)) <= 10)then
			guiSetText(GUIEditor.label[1],loc("Fraktionen_6"):format(math.floor(Drogenschiff.preis/100*150)))
