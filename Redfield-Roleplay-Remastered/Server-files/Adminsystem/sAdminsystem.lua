...
addCommandHandler("amode",function(player)
	if(getElementData(player,"Adminlevel") >= 1)then
		if(getElementData(player,"Dre4mysWorldAdminmodus") ~= true)then
			setElementData(player,"Dre4mysWorldAdminmodus",true)
			infobox(player,loc(player,"Adminsystem_121"),"info")
			setElementModel(player,260)
		else
			setElementData(player,"Dre4mysWorldAdminmodus",false)
