...
function Dre4mysWorldLobby.createLobby()
	setWindowDatas(_,"no")
	addEventHandler("onClientRender",root,Dre4mysWorldLobby.dxDraw)
	addEventHandler("onClientClick",root,Dre4mysWorldLobby.click)
end

function Dre4mysWorldLobby.dxDraw()
	...
	dxDrawText("Dre4my's World",0*(b_Width/1920),93*(b_Height/1080),1920*(b_Width/1920),200*(b_Height/1080),tocolor(227, 227, 227,255),1*(b_Height/1080),BigNoodle2,"center","top")
...
function Dre4mysWorldLobby.click(button,state)
	if(button == "left" and state == "down")then
		if(isCursorOnElement(560*(b_Width/1920),390*(b_Height/1080),800*(b_Width/1920),170*(b_Height/1080)))then
			triggerServerEvent("checkAccount",localPlayer,localPlayer)
			triggerServerEvent("checkAutologin",localPlayer)
			removeEventHandler("onClientRender",root,Dre4mysWorldLobby.dxDraw)
			removeEventHandler("onClientClick",root,Dre4mysWorldLobby.click)
...
Dre4mysWorldLobby.createLobby()
addEvent("Dre4mysWorldLobby.createLobby",true)
addEventHandler("Dre4mysWorldLobby.createLobby",root,Dre4mysWorldLobby.createLobby)